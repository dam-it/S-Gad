...
public class MenuPrincipal extends AppCompatActivity {
    ...
    //El motodo se utiliza al pinchar el boton de tips
    public void BotonTips(View view){
        Intent BotonTips = new Intent(this, Tips.class);
        startActivity(BotonTips);
    }

    public void BotonLlamadas(View view){
        Intent Llamadas = new Intent(this, LlamadasActivity.class);
